...
#this env uses a diff drive car, with the same reward function and objectives as the one used for the quadruped 
...
class QuadrupedEnv(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        #Adding the robot
        self.robot_id = p.loadURDF("racecar/racecar_differential.urdf")
    ...
    def step(self, action):
        ...
        for joint_index in range(2):  # Limit to 12 joints
